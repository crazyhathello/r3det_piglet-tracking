...
if __name__ == '__main__':
    trainsplit = DOTAImageSplitTool('/home/nas/Research_Group/Personal/Kim/piglet/r3det-on-mmdetection-master/data/train',
                                    '/home/nas/Research_Group/Personal/Kim/piglet/r3det-on-mmdetection-master/data/trainsplit',
                                    tile_overlap=(150, 150),
                                    tile_shape=(600, 600))
    trainsplit.split()
    valsplit = DOTAImageSplitTool('/home/nas/Research_Group/Personal/Kim/piglet/r3det-on-mmdetection-master/data/val',
                                  '/home/nas/Research_Group/Personal/Kim/piglet/r3det-on-mmdetection-master/data/valsplit',
                                  tile_overlap=(150, 150),
                                  tile_shape=(600, 600))
    valsplit.split()
